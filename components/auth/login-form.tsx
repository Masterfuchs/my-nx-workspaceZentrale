  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-amber-900 to-slate-900 relative overflow-hidden">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-20 left-20 w-32 h-32 bg-amber-500/10 rounded-full blur-xl" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="flex items-center mb-8">
            ...
            <span className="text-2xl font-bold">DezentraleTrading</span>
          </div>

          {/* Main Content */}
          <h1 className="text-4xl font-bold mb-6">Dezentrales Copy-Trading</h1>

          <p className="text-xl text-slate-300 mb-12 leading-relaxed">
            Folgen Sie erfolgreichen Tradern, verwalten Sie Ihre Portfolios und maximieren Sie Ihre Renditen mit unserer
            dezentralen Trading-Plattform.
          </p>

          {/* Features */}
          <div className="space-y-6 mb-12">
            <div className="flex items-center">
              <div className="w-8 h-8 bg-amber-500/20 rounded-full flex items-center justify-center mr-4">
                <div className="w-2 h-2 bg-amber-400 rounded-full" />
              </div>
              <div>
                <h3 className="font-semibold">Trading Pool Management</h3>
                <p className="text-slate-400 text-sm">Verwalten Sie mehrere Trading Pools mit Echtzeit-Analytics.</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">Sichere Blockchain-basierte Transaktionen und Transparenz.</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">Automatische Risikokontrolle und Portfolio-Schutz.</p>
              </div>
            </div>
          </div>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6">
            <p className="text-slate-300 italic mb-2">
              "DezentraleTrading hat meine Handelsstrategie revolutioniert. Die Plattform ist intuitiv und die
              Performance-Metriken sind genau das, was ich brauchte."
            </p>
            <cite className="text-sm text-slate-400">— Max Müller, Professional Trader</cite>
          </blockquote>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Melden Sie sich an, um Ihre Trading-Aktivitäten fortzusetzen</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" type="button" onClick={() => handleOAuthSignIn("google")} className="w-full">
              ...
              <Button variant="outline" type="button" onClick={() => handleOAuthSignIn("github")} className="w-full">
